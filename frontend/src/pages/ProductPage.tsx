  ...
  if (productId == null || isNaN(productId)) {
    return (
      <div className="max-w-4xl mx-auto py-12 text-center">
        ...
        <Link
          to="/catalog"
          className="inline-flex items-center gap-2 font-unbounded text-black border-2 border-black rounded-2xl px-5 py-2.5 hover:bg-black hover:text-white transition-colors"
        >
          <ArrowLeft size={18} />
          В каталог
        </Link>
